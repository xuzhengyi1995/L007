...
!function () {
    ...
    o = !e.JS_SHA512_NO_NODE_JS && "object" == typeof process && process.versions && process.versions.node;
    o && (e = global);
    ...
    h = function (e, o) {
        ...
        ee = 0,
        oe = e.length;
        384 == o ? (n = 3418070365, r = 3238371032, i = 1654270250, u = 914150663, d = 2438529370, h = 812702999, _ = 355462360, p = 4144912697, l = 1731405415, v = 4290775857, S = 2394180231, b = 1750603025, w = 3675008525, O = 1694076839, m = 1203062813, y = 3204075428) : 256 == o ? (n = 573645204, r = 4230739756, i = 2673172387, u = 3360449730, d = 596883563, h = 1867755857, _ = 2520282905, p = 1497426621, l = 2519219938, v = 2827943907, S = 3193839141, b = 1401305490, w = 721525244, O = 746961066, m = 246885852, y = 2177182882) : 224 == o ? (n = 2352822216, r = 424955298, i = 1944164710, u = 2312950998, d = 502970286, h = 855612546, _ = 1738396948, p = 1479516111, l = 258812777, v = 2077511080, S = 2011393907, b = 79989058, w = 1067287976, O = 1780299464, m = 286451373, y = 2446758561) : (n = 1779033703, r = 4089235720, i = 3144134277, u = 2227873595, d = 1013904242, h = 4271175723, _ = 2773480762, p = 1595750129, l = 1359893119, v = 2917565137, S = 2600822924, b = 725511199, w = 528734635, O = 4215389547, m = 1541459225, y = 327033209, o = 512),
        A = 0;
        do {
            for (c[0] = A, c[1] = c[2] = c[3] = c[4] = c[5] = c[6] = c[7] = c[8] = c[9] = c[10] = c[11] = c[12] = c[13] = c[14] = c[15] = c[16] = c[17] = c[18] = c[19] = c[20] = c[21] = c[22] = c[23] = c[24] = c[25] = c[26] = c[27] = c[28] = c[29] = c[30] = c[31] = c[32] = 0, N = $; oe > Z && 128 > N; ++Z)
                J = e.charCodeAt(Z), 128 > J ? c[N >> 2] |= J << a[3 & N++] : 2048 > J ? (c[N >> 2] |= (192 | J >> 6) << a[3 & N++], c[N >> 2] |= (128 | 63 & J) << a[3 & N++]) : 55296 > J || J >= 57344 ? (c[N >> 2] |= (224 | J >> 12) << a[3 & N++], c[N >> 2] |= (128 | J >> 6 & 63) << a[3 & N++], c[N >> 2] |= (128 | 63 & J) << a[3 & N++]) : (J = 65536 + ((1023 & J) << 10 | 1023 & e.charCodeAt(++Z)), c[N >> 2] |= (240 | J >> 18) << a[3 & N++], c[N >> 2] |= (128 | J >> 12 & 63) << a[3 & N++], c[N >> 2] |= (128 | J >> 6 & 63) << a[3 & N++], c[N >> 2] |= (128 | 63 & J) << a[3 & N++]);
            for (ee += N - $, $ = N - 128, Z == oe && (c[N >> 2] |= s[3 & N], ++Z), A = c[32], Z > oe && 112 > N && (c[31] = ee << 3, Y = !0), j = 32; 160 > j; j += 2)
                R = c[j - 30], T = c[j - 29], C = (R >>> 1 | T << 31)^(R >>> 8 | T << 24)^R >>> 7, g = (T >>> 1 | R << 31)^(T >>> 8 | R << 24)^(T >>> 7 | R << 25), R = c[j - 4], T = c[j - 3], x = (R >>> 19 | T << 13)^(T >>> 29 | R << 3)^R >>> 6, H = (T >>> 19 | R << 13)^(R >>> 29 | T << 3)^(T >>> 6 | R << 26), R = c[j - 32], T = c[j - 31], U = c[j - 14], V = c[j - 13], M = (65535 & V) + (65535 & T) + (65535 & g) + (65535 & H), D = (V >>> 16) + (T >>> 16) + (g >>> 16) + (H >>> 16) + (M >>> 16), E = (65535 & U) + (65535 & R) + (65535 & C) + (65535 & x) + (D >>> 16), k = (U >>> 16) + (R >>> 16) + (C >>> 16) + (x >>> 16) + (E >>> 16), c[j] = k << 16 | 65535 & E, c[j + 1] = D << 16 | 65535 & M;
            var ne = n,
            re = r,
            te = i,
            se = u,
    ...
    _.sha512_256 = u,
    _.sha512_224 = d,
    n ? module.exports = _ : (e.sha512 = h, e.sha384 = i, e.sha512_256 = u, e.sha512_224 = d, r && define(function () {
                return _
            }))
}
();
